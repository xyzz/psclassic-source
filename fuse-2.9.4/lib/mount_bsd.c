...
static const struct fuse_opt fuse_mount_opts[] = {
	{ "allow_other", offsetof(struct bsd_mount_opts, allow_other), 1 },
	{ "allow_root", offsetof(struct bsd_mount_opts, allow_root), 1 },
